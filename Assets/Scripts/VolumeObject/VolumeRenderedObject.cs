...
namespace UnityVolumeRendering
{
    ...
    public class VolumeRenderedObject : MonoBehaviour
    {
        ...
        public SlicingPlane slicingPlaneCompXY;
        public SlicingPlane slicingPlaneCompXZ;
        public SlicingPlane slicingPlaneCompZY;
        ...
        public SlicingPlane CreateSlicingPlaneXY()
        {
            GameObject sliceRenderingPlane;
            sliceRenderingPlane = GameObject.Instantiate(Resources.Load<GameObject>("SlicingPlaneX"));
            sliceRenderingPlane.transform.parent = this.volumeContainerObject.transform;
            sliceRenderingPlane.transform.localPosition = Vector3.zero;
            sliceRenderingPlane.transform.localRotation = Quaternion.identity;
            sliceRenderingPlane.transform.localScale = Vector3.one * 0.1f; // TODO: Change the plane mesh instead and use Vector3.one
            ...
            slicingPlaneCompXY = sliceRenderingPlane.GetComponent<SlicingPlane>();
            slicingPlaneCompXY.targetObject = this;
            return slicingPlaneCompXY;
        }
        public SlicingPlane CreateSlicingPlaneXZ()
        {
            GameObject sliceRenderingPlane;
            sliceRenderingPlane = GameObject.Instantiate(Resources.Load<GameObject>("SlicingPlaneY"));
            sliceRenderingPlane.transform.parent = this.volumeContainerObject.transform;
            sliceRenderingPlane.transform.localPosition = Vector3.zero;
            sliceRenderingPlane.transform.localRotation = Quaternion.identity;
            sliceRenderingPlane.transform.localScale = Vector3.one * 0.1f; // TODO: Change the plane mesh instead and use Vector3.one
            ...
            slicingPlaneCompXZ = sliceRenderingPlane.GetComponent<SlicingPlane>();
            slicingPlaneCompXZ.targetObject = this;
            slicingPlaneCompXZ.transform.localRotation = Quaternion.Euler(90.0f, 0.0f, 0.0f);
            return slicingPlaneCompXZ;
        }
        public SlicingPlane CreateSlicingPlaneZY()
        {
            GameObject sliceRenderingPlane;
            sliceRenderingPlane = GameObject.Instantiate(Resources.Load<GameObject>("SlicingPlaneZ"));
            sliceRenderingPlane.transform.parent = this.volumeContainerObject.transform;
            sliceRenderingPlane.transform.localPosition = Vector3.zero;
            sliceRenderingPlane.transform.localRotation = Quaternion.identity;
            sliceRenderingPlane.transform.localScale = Vector3.one * 0.1f; // TODO: Change the plane mesh instead and use Vector3.one
            ...
            slicingPlaneCompZY = sliceRenderingPlane.GetComponent<SlicingPlane>();
            slicingPlaneCompZY.targetObject = this;
            slicingPlaneCompZY.transform.localRotation = Quaternion.Euler(0.0f, 0.0f, 90.0f);
            return slicingPlaneCompZY;
        }
