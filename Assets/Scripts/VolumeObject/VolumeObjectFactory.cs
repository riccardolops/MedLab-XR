...
namespace UnityVolumeRendering
{
    public class VolumeObjectFactory
    {
        ...
        public static async Task<VolumeRenderedObject> CreateObjectAsync(VolumeDataset dataset, IProgressHandler progressHandler = null)
        {
            ...
            GameObject loadingObject = GameObject.Instantiate((GameObject)Resources.Load("IndeterminateLoader"));
            loadingObject.transform.position = playerCamera.transform.position + playerCamera.transform.forward * 0.7f;
            GameObject outerObject = new GameObject("VolumeRenderedObject_" + dataset.datasetName);
            outerObject.transform.position = playerCamera.transform.position + playerCamera.transform.forward * 1.0f;
            VolumeRenderedObject volObj = outerObject.AddComponent<VolumeRenderedObject>();
            ...
            GameObject.Destroy(loadingObject);
            return volObj;
        }
